...
import com.example.demo.controller.config.AccessToken;
...
public class UIController extends WebSecurityConfigurerAdapter {
    ...
    public String loadCustomers(Model model) {
        ...
        try {
            ResponseEntity<Customer[]> responseEntity = restTemplate.exchange("http://localhost:8282/services/customers", HttpMethod.GET, customerHttpEntity, Customer[].class);
